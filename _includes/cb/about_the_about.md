...
{% endcomment %}
{% assign imagesample = site.data[site.blc-compoundobjects-metadata] | where_exp: 'item','item.format contains "image"' | first %}
...
{% assign pdfsample = site.data[site.blc-compoundobjects-metadata] | where_exp: 'item','item.format contains "pdf"' | first %}
...
{% assign videosample = site.data[site.blc-compoundobjects-metadata] | where_exp: 'item','item.format contains "video"' | first %}
...
{% assign audiosample = site.data[site.blc-compoundobjects-metadata] | where_exp: 'item','item.format contains "audio"' | first %}
